...
const calendar = {
  ...
  solar2lunar: function (yPara: any, mPara: any, dPara: any) {
    ...
    return {
      date: solarDate,
      lunarDate: lunarDate,
      festival: (festival as any)[festivalDate]
        ? (festival as any)[festivalDate].title
        : null,
      lunarFestival: (lFestival as any)[lunarFestivalDate]
        ? (lFestival as any)[lunarFestivalDate].title
        : null,
      lYear: year,
      lMonth: month,
      lDay: day,
